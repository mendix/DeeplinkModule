...
public class ResponseHandler {
	...
	private static final String LOGINPAGE = "login.html?c=";
	...
	public static void serveSSOHandler(IMxRuntimeRequest request, IMxRuntimeResponse response)
			throws UnsupportedEncodingException, UnexpectedException {
	...
	public static void serveLogin(IMxRuntimeRequest request, IMxRuntimeResponse response)
		...
		StringBuilder host = new StringBuilder(scheme).append("://").append(serverName).append(":").append(port);
