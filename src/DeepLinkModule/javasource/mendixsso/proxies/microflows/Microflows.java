...
public class Microflows
{
	...
	public static mendixsso.proxies.MendixSSOSettings getOrCreateMendixSSOSettings(IContext context)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		IMendixObject result = (IMendixObject)Core.microflowCall("MendixSSO.GetOrCreateMendixSSOSettings").withParams(params).execute(context);
		return result == null ? null : mendixsso.proxies.MendixSSOSettings.initialize(context, result);
	}
	...
	public static void iVK_SaveAdditionalScopes(IContext context, mendixsso.proxies.AdditionalScopes _additionalScopes)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("AdditionalScopes", _additionalScopes == null ? null : _additionalScopes.getMendixObject());
		Core.microflowCall("MendixSSO.IVK_SaveAdditionalScopes").withParams(params).execute(context);
	}
	...
	public static void iVK_UpdateAdditionalScopes(IContext context, mendixsso.proxies.MendixSSOConfigurationView _mendixSSOConfigurationView)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("MendixSSOConfigurationView", _mendixSSOConfigurationView == null ? null : _mendixSSOConfigurationView.getMendixObject());
		Core.microflowCall("MendixSSO.IVK_UpdateAdditionalScopes").withParams(params).execute(context);
	}
	...
	public static void oCh_UpdateAutomaticAnonymousLogin(IContext context, mendixsso.proxies.MendixSSOConfigurationView _mendixSSOConfigurationView)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		params.put("MendixSSOConfigurationView", _mendixSSOConfigurationView == null ? null : _mendixSSOConfigurationView.getMendixObject());
		Core.microflowCall("MendixSSO.OCh_UpdateAutomaticAnonymousLogin").withParams(params).execute(context);
	}
	...
	public static void sE_CleanupAuthRequests(IContext context)
	{
		Map<java.lang.String, Object> params = new HashMap<>();
		Core.microflowCall("MendixSSO.SE_CleanupAuthRequests").withParams(params).execute(context);
	}
